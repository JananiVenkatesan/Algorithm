...
you beforehand.  
(i.e., 0 1 2 3 4 5 6 might become 2 3 4 5 6 0 1 ).
...
public int search(int[] A, int x){
    ...
    while(left <= right){
        ...
        // 0 1 2 3 4 5 6 might become 2 3 4 5 6 0 1 
        if(A[left] <= A[mid]){  // IMPORTANT!!! <=  
            if(A[left] <= x && x < A[mid])
                right = mid - 1;
            else
                left = mid + 1;
        }
        else{                   // 0 1 2 3 4 5 6 might become 4 5 6 0 1 2 3
