...
int updateBits(int n, int m, int i, int j){
	...
	*/
	...
	int n_cleared = n & mask;  // Clear bits j through i. 0010 1110 | 1110 0011 = 0010 0010
	int m_shifted = m << i;    // Move m into correct position. 101 << 2 = 1 0100

	return n_cleared | m_shifted;  // OR them 0010 0010 | 1 0100 = 0011 0110
}
